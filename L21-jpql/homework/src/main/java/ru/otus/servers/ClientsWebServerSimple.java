...
public class ClientsWebServerSimple implements ClientsWebServer {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new ClientsServlet(templateProcessor, clientDataTemplateHibernate)), "/users");
        servletContextHandler.addServlet(new ServletHolder(new ClientsApiServlet(clientDataTemplateHibernate, gson)), "/api/user/*");
        return servletContextHandler;
    }
}
